...
class VLMServer:
    ...
    def _load_checkpoint_w16a16(self):
        ...
        for _ in pbar:
            ...
            load_8bit = getattr(self.args, 'load_8bit', False)
        ...
        print(f"Model loaded on {self.args.device}, 8bit={load_8bit}")
        ...
        while True:
            ...
            try:
                ...
                try:
                    ...
                    print(f"Ignoring malformed request from {addr}: {exc}", flush=True)
                    continue
