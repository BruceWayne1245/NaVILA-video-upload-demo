...
This module deliberately lives under the unique ``anchor_transition_runtime``
package.  The evaluator also imports the established V1.1 ``reliability``
package, so placing these modules under a second package with the same name
causes Python to reuse the already-loaded package and hide this runtime.
"""
