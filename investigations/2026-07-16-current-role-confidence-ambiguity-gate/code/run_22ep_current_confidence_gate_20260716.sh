...
echo "[master] with the new opt-in --sequential_pair_current_confidence_ambiguity_gate (2026-07-16) added on top"
echo "[master] of the identical Variant-1 config (sequential_pair_quarantine_next_quality left OFF per the"
echo "[master] 2026-07-15 decision not to pursue it further), to see whether the new stateless current-role"
echo "[master] confidence gate helps any of the 8 known return-failures (134,367,994,319,708,498,354,214)"
echo "[master] without regressing any of the 14 known successes."

export RUN_TAG="shadow_current_confidence_gate_22ep_20260716"
