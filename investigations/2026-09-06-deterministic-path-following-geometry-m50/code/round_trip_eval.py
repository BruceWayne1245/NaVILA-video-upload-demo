...
parser.add_argument(
    ...
    help=(
        ...
        "hint/arbiter and stop-gate decisions with a deterministic reverse-"
        "breadcrumb controller. Requires --route_memory."
    ),
)
...
if args_cli.deterministic_path_following_return:
    ...
    incompatible = [
        name for name in ("hint_action_arbiter", "stop_gate", "stuck_recovery")
