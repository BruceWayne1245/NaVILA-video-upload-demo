...
RAW = os.path.join(REPO, "_raw_repair_r2")
SEG = os.path.join(REPO, "segments_repair_r2")
TMP = os.path.join(RAW, "_scaled_v2")
FINAL = os.path.join(REPO, "final_v2_source_render_fix_20260920_r2.mp4")
