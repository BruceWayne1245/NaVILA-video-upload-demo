...
RAW_DIR = os.path.join(REPO, "_raw_repair_r2")
...
def main():
    ...
    n = render_pair_side_by_side(
        ...
        arrow_overrides={2305: {"overridden_source": "right_hint"}},
    ...
    n = render_pair_side_by_side(
        ...
        pause_raw_frames=PAUSE_FRAMES["seg4_main"], max_events=1, exclude_steps=(1905, 2005),
    ...
    n = render_pair_side_by_side(
        ...
        arrow_overrides={2155: {"overridden_source": "right_vlm"}},
