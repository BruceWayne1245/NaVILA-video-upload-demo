...
# RESUME 2026-07-22: ep4 already completed successfully (round_trip_success=True) in the
# aborted 2026-07-21 run; the batch died when its launching session disconnected (systemd
# KillUserProcesses). This resume drops ep4 from BOTH lists so it is not rerun and does not
# leak into REST. Same RUN_TAG -> same LOG_DIR -> ep4's summary row is preserved. 26+73=99.
# batch2 outbound-success minus ep4 (26) -- from scratch_inv/an/paths.py OUTBOUND_SUCCESS
SUCCESS_LIST="5 20 88 89 189 268 277 295 319 367 368 382 491 498 500 537 589 647 653 669 680 783 813 889 994 1038"
# full set minus ep4 (99), exactly as the driver iterates it
FULL_LIST="5 134 187 367 368 408 678 680 994 1040 144 166 1008 1058 89 647 381 651 409 639 319 49 488 56 273 708 486 1068 498 974 640 1000 1038 500 1011 589 758 875 295 973 342 515 281 268 96 354 347 430 214 338 277 410 137 198 189 491 963 55 337 289 813 537 932 382 726 546 336 889 20 1004 178 783 162 467 653 88 136 1002 1035 669 1042 692 652 248 953 1001 696 1039 525 271 447 386 830 122 670 534 436 290 135"
