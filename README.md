...
**Latest update (2026-07-04) — yesterday's "environment hang" that blocked `--measured_odometry` validation was root-caused to two real bugs, not environment/resource state; both fixed, and `--measured_odometry` is now validated.**
